...
<body style="margin: 0;background: #eee;">
	<div class="wrapper" style="width: 620px;margin: auto;background: white;box-shadow: 0px 0px 10px #999;">
        ...
        <div class="hero" style="background: #333;min-height: 200px;max-height: 500px;">
        	<img src="{$email.hero.image}" style="border: none;max-width: 620px;max-height: 500px;display: block;">
        </div>
