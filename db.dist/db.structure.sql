...
CREATE TABLE `bancontrol` (
  ...
  KEY `ip` (`ip`)
) ENGINE=InnoDB AUTO_INCREMENT=12038 DEFAULT CHARSET=utf8 TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `download_items` (
  ...
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=808 DEFAULT CHARSET=utf8 TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=144 DEFAULT CHARSET=utf8 TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=171 DEFAULT CHARSET=utf8 TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fwlink` (
  ...
  `title` text NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20707 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `image` (
  ...
  KEY `lat` (`lat`,`lon`)
) ENGINE=InnoDB AUTO_INCREMENT=12023 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=36349 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=402 DEFAULT CHARSET=utf8 COMMENT='Define an offset position for an image. Useful for loco cover photos.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='Railpage JobNet - Advertised positions';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `jn_locations` (
  ...
  KEY `jn_parent_id` (`jn_parent_id`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8 COMMENT='Railpage JobNet - Job locations';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=410 DEFAULT CHARSET=utf8 TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `loco_class` (
  ...
  KEY `asset_id` (`asset_id`),
  KEY `country` (`country`)
) ENGINE=InnoDB AUTO_INCREMENT=366 DEFAULT CHARSET=utf8 TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=771 DEFAULT CHARSET=utf8 TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `loco_livery` (
  ...
  KEY `region` (`region`),
  KEY `country` (`country`)
) ENGINE=InnoDB AUTO_INCREMENT=162 DEFAULT CHARSET=utf8 TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `loco_manufacturer` (
  ...
  KEY `slug` (`slug`)
) ENGINE=InnoDB AUTO_INCREMENT=92 DEFAULT CHARSET=utf8 TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=347 DEFAULT CHARSET=utf8 TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=21672 DEFAULT CHARSET=utf8 TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `loco_unit` (
  ...
  KEY `asset_id` (`asset_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7123 DEFAULT CHARSET=utf8 TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `loco_unit_corrections` (
  ...
  KEY `loco_id` (`loco_id`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=67 DEFAULT CHARSET=utf8 TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=176297 DEFAULT CHARSET=utf8 TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `log_general` (
  ...
  KEY `key` (`key`)
) ENGINE=InnoDB AUTO_INCREMENT=103277 DEFAULT CHARSET=utf8 TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `log_herrings` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3231 DEFAULT CHARSET=utf8 TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1142203 DEFAULT CHARSET=utf8 TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `log_staff` (
  ...
  KEY `title` (`title`),
  KEY `key` (`key`,`key_val`)
) ENGINE=InnoDB AUTO_INCREMENT=3945 DEFAULT CHARSET=utf8 TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `log_useractivity` (
  ...
  KEY `time` (`time`),
  KEY `ip` (`ip`)
) ENGINE=InnoDB AUTO_INCREMENT=13515 DEFAULT CHARSET=utf8 TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1943282 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=53509 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=327818 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `nuke_bbranks` (
  ...
  PRIMARY KEY (`rank_id`)
) ENGINE=InnoDB AUTO_INCREMENT=64 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `nuke_bbtopics` (
  ...
  KEY `url_slug` (`url_slug`)
) ENGINE=InnoDB AUTO_INCREMENT=11379354 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `nuke_nucal_events` (
  ...
  KEY `flagged` (`flagged`),
  KEY `organisation_id` (`organisation_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1287 DEFAULT CHARSET=utf8 TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=15103 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=72129 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PACK_KEYS=0;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=31582 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `nuke_users_notes` (
  ...
  PRIMARY KEY (`nid`)
) ENGINE=InnoDB AUTO_INCREMENT=757113 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=8264 DEFAULT CHARSET=utf8 PAGE_CHECKSUM=1 TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `phpbb_reports_posts` (
  ...
  KEY `post_id` (`post_id`),
  KEY `poster_id` (`poster_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8232 DEFAULT CHARSET=utf8 PAGE_CHECKSUM=1 TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=7093 DEFAULT CHARSET=utf8 TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tag` (
  ...
  PRIMARY KEY (`tag_id`),
  UNIQUE KEY `tag` (`tag`)
) ENGINE=InnoDB AUTO_INCREMENT=3812 DEFAULT CHARSET=utf8 PAGE_CHECKSUM=1 TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tag_link` (
  ...
  KEY `post_id` (`post_id`),
  KEY `photo_id` (`photo_id`)
) ENGINE=InnoDB AUTO_INCREMENT=12518 DEFAULT CHARSET=latin1 PAGE_CHECKSUM=1 TRANSACTIONAL=1;
/*!40101 SET character_set_client = @saved_cs_client */;
