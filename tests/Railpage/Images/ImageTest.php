<?php
	...
	class ImageTest extends PHPUnit_Framework_TestCase {
		...
		public function testFetchFlickr() {
			$Image = (new Images)->getImageFromUrl("https://www.flickr.com/photos/doctorjbeam/17309304565/");
		...
		public function testFetchSmugMug() {
			$Image = (new Images)->getImageFromUrl("http://sjbphotography.smugmug.com/Railways/The-Adventures/Epic-Adventures/The-International-Adventures/Steel-Steam-Stars-IV/i-7kHVHtX/A");
